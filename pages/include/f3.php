<?php
  ...
  while($r1=$s1->fetch()){
    ...
    for ($i1=0; $i1 < count($a1); $i1++) {
      $d1='../../media/'.$a1[$i1];
      $ott1.='<audio controls controlsList="nodownload"><source src="'.$d1.'" type="audio/wav"></audio><br>';
    }
    $ot.='
      <tr>
        <td>'.$r1[0].'</td>
        ...
        <td><button type="submit" class="btn btn-danger m-t-15 waves-effect bt-d" data-id1="'.$r1[0].'">x</button></td>
      </tr>
    ';
    $ott1='';
  }
