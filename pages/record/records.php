<?php
  ...
  include '../include/f2.php';
  // header("Cache-Control: no-cache, must-revalidate");
  // header("Expires: Mon, 26 Jul 1997 05:30:00 GMT");
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        <i class="fa fa-sign-out fa-lg mb-4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"></i>
                        <i class="fa fa-sign-in fa-lg mb-4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"></i>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="javascript:void(0);"><i class="fa fa-user fa-lg"></i> Profile</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="javascript:void(0);"><i class="fa fa-sign-out" aria-hidden="true"></i> Sign Out</a></li>
                            <li><a href="javascript:void(0);"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign In</a></li>
                        </ul>
                    </div>
                </div>
            </div>
