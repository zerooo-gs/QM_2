<?php
  // header('pages/record/records.php')
  echo "<script> location.href='pages/record/records.php'; </script>";
?>
<!DOCTYPE html>
<html>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
              <ul class="list">
                  ...
                  <li class="active">
                    <a href="pages/forms/form_upload.php">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2022 - <?php echo date('Y');?> | <a>A Project by Gayan - FBC IT</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.3.0
                </div>
